    ...
    <div className='w-full bg-[#030712] text-gray-300 py-16 border-t border-lightNavy/30'>
      <div className='max-w-[1100px] mx-auto flex flex-col items-center justify-center px-4'>
        <div className='flex space-x-12 mb-10'>
          <a href="https://github.com/nischalsb" target="_blank" rel="noopener noreferrer" className='text-gray-400 hover:text-secondary hover:scale-110 transition-all duration-300'>
